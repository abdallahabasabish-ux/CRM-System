// =============================================================
// settings.js - الإصدار النهائي مع دعم الوضع المظلم
...
async function checkAdminPrivileges(user) {
  try {
    ...
    // قائمة البريد الإلكتروني للمدراء (صلاحية مطلقة)
    ...
    // إذا كان مديراً وليس لديه وثيقة في Firestore، نقوم بإنشائها
...
// =============================================================
// 6.  المصادقة والتحقق من الصلاحية
// =============================================================
...
// =============================================================
// 7.  تحميل قائمة المستخدمين (Realtime)
// =============================================================
function loadUsers() {
      ...
      <tr>
        <td>
          <div class="d-flex align-items-center gap-2">
            <div style="width:32px;height:32px;border-radius:50%;background:var(--color-primary);color:#fff;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:14px;">
...
// =============================================================
// 10.  تبديل حالة المستخدم (تفعيل/تعطيل)
// =============================================================
...
// =============================================================
// 12.  إضافة مستخدم جديد (معالج الحدث)
// =============================================================
...
// =============================================================
// 15.  إعادة تعيين المودال عند الإغلاق
// =============================================================
...
console.log('✅ Settings.js loaded successfully (Full version)');
